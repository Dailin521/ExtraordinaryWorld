    ...
    public class Boot : MonoBehaviour
    {
        ...
        IEnumerator LoadTest()
        {
            ...
            else if (PlayMode == EPlayMode.HostPlayMode)
            {
                ...
                initParameters.DefaultHostServer = "https://cdn-1257380158.cos.ap-nanjing.myqcloud.com/ARPG/WebGL/" + version;
        ...
        IEnumerator Start1()
        {
            ...
            SceneOperationHandle scene = YooAssets.LoadSceneAsync("Start_Night", sceneMode, activateOnLoad);
